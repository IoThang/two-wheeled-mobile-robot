...
void main(void) {
    ...
    while(1)
    {
        ...
        if((0 == PORTBbits.RB0) && (0 == PORTBbits.RB1) && (0 == PORTBbits.RB2))
        {
            car(1);
        }
        if((0 == PORTBbits.RB1))
        ...
        if(((0 == PORTBbits.RB1) && (0 == PORTBbits.RB0)))
        {
            car(3);
        }
        if((0 == PORTBbits.RB2))
        ...
        if(((0 == PORTBbits.RB2) && (0 == PORTBbits.RB0)))
        {
            car(2);
        }
        if((1 == PORTBbits.RB0) && (1 == PORTBbits.RB1) && (1 == PORTBbits.RB2))
        {
            car(8);
        }
        if(temp < 5)
